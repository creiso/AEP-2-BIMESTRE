...
public class BlockChain {
    ...
    public void criarBlockchain() {

        System.out.println("Bem-vindo! Para cadastrar uma pessoa, digite as seguintes informações:");
        System.out.println("Nome, Data de Nascimento, Cidade, Estado e País e e-mail.");
        ...
        pessoab.adicionar("Maria Pereira, 22/11/1995, 258.369.548-77, Ipiranga, Paraná, Brasil");

        pessoac.adicionar("Pedro da Silva, 13/02/2001, 158.354.852-45, Ponta Grossa, Paraná, Brasil");

        pessoad.adicionar("Brenda Santos, 10/06/2001, 147.254.365-87, Ponta Grossa, Paraná, Brasil");

        pessoae.adicionar("Cleison Alves, 14/05/1970, 156.372.482-35, Palmeira, Paraná, Brasil");
        ...
        System.out.println("A semente desse bloco é: " + pessoaa.get(0).getValor() + pessoaa.get(0).getValor().hashCode() * pessoab.get(0).getValor().hashCode());
        System.out.println("A hash desse bloco é: " + pessoaa.get(0).getValor().hashCode() * pessoab.get(0).getValor().hashCode()
